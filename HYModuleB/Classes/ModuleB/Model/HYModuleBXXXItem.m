...
@interface HYModuleBXXXItem ()

@end


@implementation HYModuleBXXXItem
...
- (nonnull NSString *)description {
    ...
    NSString *description = [NSString stringWithFormat:@"MduleB: itemName == %@, itemAge == %d", self.itemName, self.itemAge];
    return description;
}
