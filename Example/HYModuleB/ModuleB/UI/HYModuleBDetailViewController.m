...
//
//    self.moduleABtn.frame = CGRectMake(20, rect.size.height - 100, rect.size.width - 40, 40);
}
...
//- (void)jumpModuleBAction:(UIButton *)sender {
//    BOOL isExist = [HYComponentManager canRouteURL:[NSURL URLWithString:@"hycScheme://ModuleADetail"]];
//    if (isExist) {
